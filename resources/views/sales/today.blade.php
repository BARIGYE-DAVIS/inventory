...
@section('page-title')
    <i class="fas fa-calendar-day text-green-600 mr-2"></i>Today's Sales - {{ now()->format('D, d M Y') }}
@endsection

@section('content')
<!-- Stats Card -->
<div class="bg-gradient-to-br from-green-500 to-green-600 text-white rounded-xl shadow-lg p-6 mb-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-green-100 text-sm mt-1">{{ $totalSales }} transactions • {{ $totalItems ?? 0 }} items sold</p>
        </div>
...
<div class="bg-white rounded-xl shadow-lg p-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 space-y-4 md:space-y-0">
        ...
        <div class="flex space-x-2 overflow-x-auto">
            ...
            <a href="{{ route('sales.today') }}" class="px-4 py-2 bg-green-600 text-white rounded-lg whitespace-nowrap">
        ...
        <div class="flex space-x-2">
            ...
            <!-- Export Excel -->
            <a href="{{ route('sales.export.today') }}" class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
    ...
    <div class="overflow-x-auto" id="printableArea">
        ...
        <div class="print-only" style="display: none;">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600">Today's Sales Report</p>
...
<style>
    @media print {
        ...
        .bg-gray-50, .bg-green-50, .hover\:bg-gray-50 {
...
<script>
    ...
    function shareWhatsApp() {
        ...
        const date = "{{ now()->format('d M Y') }}";
        
        const message = `📊 *Today's Sales Report* 📊\n\n` +
                       `🏢 ${businessName}\n` +
                       `📅 ${date}\n\n` +
    ...
    function shareEmail() {
        ...
        const subject = `Today's Sales Report - ${date}`;
        const body = `Today's Sales Report\n\n` +
