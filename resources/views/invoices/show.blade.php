...
@section('page-title')
    <i class="fas fa-file-invoice-dollar text-indigo-600 mr-2"></i>Invoice - {{ $invoice->invoice_number }}
@endsection

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="no-print mb-4 flex justify-between items-center">
        <a href="{{ route('invoices.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8" id="invoice">
        <!-- Business Header -->
        ...
        <div class="grid grid-cols-2 gap-6 mb-6 pb-6 border-b border-gray-200">
            ...
            <div>
                ...
                @if($invoice->customer)
                    ...
                    @endif
                @else
                    <p class="text-gray-600">Unknown Customer</p>
                @endif
            </div>
        </div>
